...
if aienv == None:
    openai.api_key = "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"
else:
...
if tgenv == None:
    tgkey = "6257376830:AAEBQn5tpronEfI4jZaBXFJvvHmlyC36OZI"
else:
    tgkey = tgenv
print(tgenv)
